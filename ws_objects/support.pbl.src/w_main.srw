...
type st_ellipsis from statictext within w_main
end type
type ddlb_backup from dropdownlistbox within w_main
end type
type p_logo from picture within w_main
end type
type sle_password from singlelineedit within w_main
end type
type sle_login_id from singlelineedit within w_main
end type
type st_password from statictext within w_main
end type
type st_login_id from statictext within w_main
end type
type cb_cancel from commandbutton within w_main
end type
type cb_ok from commandbutton within w_main
end type
type st_backbround from statictext within w_main
end type
type mle_about from multilineedit within w_main
end type
end forward
...
event ue_init();f_Register_Main_Window(This)
